...
fn benchmark_proof_verification(c: &mut Criterion) {
    ...
    for &ballot_size in &[4, 8, 16, 32, 64, 128, 256] {
        ...
        let validity_proof = no_budget::generate_proof(ballot_no_budget.clone(), &bp_params_no_budget);
        ...
        let validity_proof = max_budget::generate_proof(&bp_params_max_budget, ballot_max_budget.clone());
